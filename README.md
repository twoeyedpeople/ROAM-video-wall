...
- The countdown is a title card, **"UP NEXT / {NAME}'S"** over the ROAM logo, then the leader counts 3, 2, 1 with the sweep going round, and cuts to black as the hand passes straight down on the 1. The film starts out of that black. 2.4 s of title, 1.2 s a digit, 6 s in all. A guest who left the name blank gets "FREEDOM TO" over the same logo.
